 ...
 */
final class Version20251024082919 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entrainement (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, learning_path_id VARCHAR(255) NOT NULL, structure_hash VARCHAR(64) DEFAULT NULL, UNIQUE INDEX UNIQ_A27444E560A2109A (structure_hash), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
