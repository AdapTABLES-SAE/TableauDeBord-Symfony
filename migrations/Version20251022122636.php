 ...
 */
final class Version20251022122636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE eleve (id INT AUTO_INCREMENT NOT NULL, classe_id BIGINT DEFAULT NULL, entrainement_id INT DEFAULT NULL, learner_id VARCHAR(255) NOT NULL, nom_eleve VARCHAR(255) NOT NULL, prenom_eleve VARCHAR(255) NOT NULL, current_learning_path_id VARCHAR(255) DEFAULT NULL, INDEX IDX_ECA105F78F5EA509 (classe_id), INDEX IDX_ECA105F7A15E8FD (entrainement_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE entrainement (id INT AUTO_INCREMENT NOT NULL, learning_path_id VARCHAR(255) NOT NULL, structure_hash VARCHAR(64) DEFAULT NULL, UNIQUE INDEX UNIQ_A27444E560A2109A (structure_hash), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
